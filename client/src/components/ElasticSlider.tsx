...
interface ElasticSliderProps {
    ...
    onChange?: (value: number) => void; // Added for controlled usage
}
...
const Slider: React.FC<SliderProps> = ({
    ...
    // Sync internal state with prop changes for controlled behavior
    useEffect(() => {
    ...
    return (
        <>
            <motion.div
                ...
                className="flex w-full touch-none select-none items-center justify-center gap-4 text-white"
            >
                <motion.div
                    animate={{
